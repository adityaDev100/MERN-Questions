...
// 2. Do this by using recursion

function binarySearchByRecursion(arr, target, startIndex, endIndex) {
...
let arr = [3, 15, 26, 33, 42, 51, 54, 65, 67];
let targetResult = 51;
let startIndex = 0;
let endIndex = arr.length;
const resultIndex = binarySearchByRecursion(
  arr,
  targetResult,
  startIndex,
  endIndex
